...
**Global.** It feels different when you build something that is helpful for an Indian guy from Telangana and your friends from college at the same time. It expands your thinking. In contrast, unless you can afford to study abroad, in most fields, the work you can do will be local to your country or city.
